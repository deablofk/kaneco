...
public class KanecoListener extends ListenerAdapter {
	...
	static {
		...
		COMMANDS.put("s", new Skip());
		COMMANDS.put("mv", new Move());
		COMMANDS.put("dc", new Disconnect());
		...
		if (event.getSelectMenu().getId().equals("helpmenu")) {
			...
			switch(label){
				case "music":
					...
					builder.setDescription("<:black_arrow_right:940445321652215829> play <url ou musica> - adiciona uma musica na queue.\n\n"
					...
					//	+"<:black_arrow_right:940445321652215829> playstart/pstart - ativa o playstart, tudo o que digitar passa a ser considerado comando de play.\n\n"
					//	+"<:black_arrow_right:940445321652215829> playstop/pstop - desativa o playstart, torna manual a adição de músicas.\n\n");
					break;
				case "moderation":
					builder.setTitle("Moderação");
					builder.setDescription("<:black_arrow_right:940445321652215829> warn <@id> motivo - avisa um usuario sobre determinada infração.\n\n"
				...
				case "minecraft":
					...
					//builder.setDescription("<:black_arrow_right:940445321652215829> mcavatar <nick_mine_java> - mostra o avatar de uma conta minecraft.\n\n"
					//		+"<:black_arrow_right:940445321652215829> mcping <server-ip:porta> - mostra players conectados no minecraft.\n\n"
					//		+"<:black_arrow_right:940445321652215829> mcskin <nick_mine_java> - mostra a skin de uma conta minecraft.\n\n");
					break;
				case "users":
					builder.setTitle("Usuário");
					builder.setDescription("<:black_arrow_right:940445321652215829> avatar <@id> - mostra o avatar de um usuário ou o seu.\n\n"
	...
	public void onGuildMemberJoin(GuildMemberJoinEvent event) {
		try{
			...
			if(config.getWelcomeMessage() != null) {
				...
				if(channel != null) {
					channel.sendMessage(event.getMember().getAsMention() + " " + config.getWelcomeMessage()).complete().delete().queueAfter(30, TimeUnit.SECONDS);
				}
			}
